...
file2_content=${file2_content//"// @downloadURL https://update.greasyfork.org/scripts/443888/Additional%20Bypass.user.js"/"// @downloadURL https://github.com/FiorenMas/Shortlink/releases/download/all/ShortLink2-modified.user.js"}
